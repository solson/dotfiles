...
let g:colors_name="codedark_solson"
...
call <sid>hi('DiffAdd', s:cdLightGreen, s:cdLeftDark, 'none', {})
call <sid>hi('DiffChange', s:cdBlue, s:cdLeftDark, 'none', {})
call <sid>hi('DiffDelete', s:cdRed, s:cdLeftDark, 'none', {})
call <sid>hi('DiffText', s:cdBlue, s:cdLeftMid, 'none', {})
...
call <sid>hi('CocGitChangedSign', s:cdBlue, s:cdNone, 'none', {})
call <sid>hi('CocGitAddedSign', s:cdGreen, s:cdNone, 'none', {})
call <sid>hi('CocGitRemovedSign', s:cdRed, s:cdNone, 'none', {})
call <sid>hi('CocGitTopRemovedSign', s:cdRed, s:cdNone, 'none', {})
call <sid>hi('CocGitChangeRemovedSign', s:cdBlue, s:cdNone, 'none', {})
